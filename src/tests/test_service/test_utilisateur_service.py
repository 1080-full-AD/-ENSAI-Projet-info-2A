...
liste_utilisateur = [
    Utilisateur(pseudo="Naruto54", age=16, mdp=("mdpManga4#", "Naruto54"), id_utilisateur = 1),
    Utilisateur(pseudo="missmanga", age=18, mdp=("126OnePiece#", "missmanga"), id_utilisateur = 2),
...
def test_trouver_par_pseudo_utilisateur_echec():
    ...
    mock_dao = MagicMock(spec=UtilisateurDao)
    mock_dao.trouver_tous_utilisateur.side_effect = Exception("Erreur de base"
                                                              "de données")
...
def test_lister_tous_utilisateur_echec():
    ...
    mock_dao = MagicMock(spec=UtilisateurDao)
    mock_dao.lister_tous_utilisateur.side_effect = Exception("Erreur de base"
                                                             "de données")
...
def test_create_password_ok():
    ...
    # GIVEN
    pseudo, age, mdp, collections, id_utilisateur = "Naruto54", 16, "mdpManga##7#", ["Monster", "One Piece", "Naruto"], 678
    mock_dao = MagicMock(spec=UtilisateurDao)
    ...
    # WHEN
    utilisateur = utilisateur_service.create_password(pseudo, age, mdp,
                                                      collections,
                                                      id_utilisateur)
...
def test_create_password_echec():
    ...
    # GIVEN
    pseudo, age, mdp, collections, id_utilisateur = "Naruto54", 16, "123456##7#", ["Monster", "One Piece", "Naruto"], 678
    mock_dao = MagicMock(spec=UtilisateurDao)
