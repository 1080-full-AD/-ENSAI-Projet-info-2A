INSERT INTO projet.manga (id_manga,titre_manga,synopsis,auteurs) VALUES 
(1, 'Monster', 'Kenzou Tenma, a renowned Japanese neurosurgeon working in post-war Germany, faces a difficult choice: to operate on Johan Liebert, an orphan boy on the verge of death, or on the mayor of D�sseldorf. In the end, Tenma decides to gamble his reputation by saving Johan, effectively leaving the mayor for dead.
...
[Written by MAL Rewrite]', 'Urasawa, Naoki'),
(2, 'Berserk', 'Guts, a former mercenary now known as the Black Swordsman, is out for revenge. After a tumultuous childhood, he finally finds someone he respects and believes he can trust, only to have everything fall apart when this person takes away everything important to Guts for the purpose of fulfilling his own desires. Now marked for death, Guts becomes condemned to a fate in which he is relentlessly pursued by demonic beings.
...
Included one-shot:
Volume 14: Berserk: The Prototype', 'Miura, Kentarou, Studio Gaga'),
(3, '20th Century Boys', 'As the 20th century approaches its end, people all over the world are anxious that the world is changing. And probably not for the better.
...
[Written by MAL Rewrite]', 'Urasawa, Naoki'),
(4, 'Yokohama Kaidashi Kikou', 'In a post-apocalyptic world where an environmental disaster led to the eruption of Mt. Fuji and the inundation of Yokohama, the age of humans is in its twilight. Alpha Hatsuseno is an android and the namesake of a small cafe outside Yokohama. As her owner is away on a trip indefinitely, she has been left responsible for running the cafe. Although she rarely gets any customers, Alpha remains outgoing and cheerful.
...
[Written by MAL Rewrite]', 'CLAMP'),
(10, 'xxxHOLiC', 'Living alone after his parents passed away, Kimihiro Watanuki is a high school student who can see otherworldly creatures that are attracted to him. His days are plagued by these nuisances, and he wishes to rid himself of this inconvenience. One fateful day, as Kimihiro is being chased by a horde of spirits, his feet bring him into a mysterious store to seek shelter. Here he meets Yuuko Ichihara, the mistress of this supposed store, who claims to be able to grant wishes. Yuuko offers to grant Kimihiro"s, as long as he pays an appropriate price.
...
[Written by MAL Rewrite]', 'Kubo, Tite'),
(13, 'One Piece', 'Gol D. Roger, a man referred to as the King of the Pirates, is set to be executed by the World Government. But just before his demise, he confirms the existence of a great treasure, One Piece, located somewhere within the vast ocean known as the Grand Line. Announcing that One Piece can be claimed by anyone worthy enough to reach it, the King of the Pirates is executed and the Great Age of Pirates begins.
...
[Written by MAL Rewrite]', 'Obata, Takeshi, Ohba, Tsugumi'),
(22, 'Rurouni Kenshin: Meiji Swordsman Romantic Story', 'Ten years have passed since the end of Bakumatsu, an era of war that saw the uprising of citizens against the Tokugawa shogunate. The revolutionaries wanted to create a time of peace, and a thriving country free from oppression. The new age of Meiji has come, but peace has not yet been achieved. Swords are banned but people are still murdered in the streets. Orphans of war veterans are left with nowhere to go, while the government seems content to just line their pockets with money.
...
Included one-shot:
Volume 28: Meteor Strike', 'Watsuki, Nobuhiro'),
(23, 'Ranma 1/2', 'Soun Tendou runs the Tendou Martial Arts School accompanied by his three daughters: Akane, Nabiki, and Kasumi. One day, the sisters" lives are turned upside down when their father announces that he has promised one of them to be married to a fellow martial artist"s son in hopes of carrying on the family legacy. In addition to their mixed reactions, when the fianc� arrives, the last thing the Tendou family expects is Ranma Saotome and his father, Genma.
...
[Written by MAL Rewrite]', 'Arakawa, Hiromu'),
(26, 'Hunter x Hunter', '"Secret treasure hoards, undiscovered wealth... mystical places, unexplored frontiers... "The mysterious unknown." There"s magic in such words for those captivated by its spell. They are called "Hunters"!"
...
[Written by MAL Rewrite]', 'Togashi, Yoshihiro'),
(27, 'X', 'Six years ago, Kamui Shirou and siblings Fuuma and Kotori Monou were inseparable childhood friends. After the sudden, gruesome death of the Monou siblings" mother, Kamui was taken away from Tokyo by his own mother. In the years that passed, the two lived peacefully while Kamui strengthened his innate telekinetic abilities. When his mother passes away in 1999, her dying wish prompts him to return to Tokyo to face his "destiny."
