...
[Written by MAL Rewrite]', 'Urasawa, Naoki',18,162),
...
Included one-shot:
Volume 14: Berserk: The Prototype', 'Miura, Kentarou, Studio Gaga',NULL,NULL),
...
[Written by MAL Rewrite]', 'Urasawa, Naoki',22,249),
...
[Written by MAL Rewrite]', 'Morikawa, George',NULL,NULL),
...
Included one-shot:
Volume 2: Ginyuu Meika', 'Tanemura, Arina',7,35),
...
[Written by MAL Rewrite]', 'CLAMP',28,233),
...
[Written by MAL Rewrite]', 'CLAMP',19,213),
...
[Written by MAL Rewrite]', 'Kishimoto, Masashi',72,700),
...
[Written by MAL Rewrite]', 'Kubo, Tite',74,705),
...
[Written by MAL Rewrite]', 'Oda, Eiichiro',NULL,NULL),
...
[Written by MAL Rewrite]', 'Akamatsu, Ken',38,355),
...
Volume 8: Abareru Ousama (The Raging King)', 'Tsuda, Masami',21,108),
(18, 'Kodomo no Omocha', 'Sana Kurata, a child actress, faces many problems in her classroom, including a major one - her bullying classmate, Akito Hayama. Sana"s outgoing and friendly nature leads her to work towards correcting all of the problems around her. Her "meddling" irritates Hayama but at the same time captivates him, just as Hayama"s gloomy nature irritates Sana and compels her to change him. As these two opposites attract each other, they face many hardships which bring them closer to a mutual understanding.

(Source: ANN)', 'Obana, Miho',10,54),
...
(Source: Tokyopop)', 'Kibayashi, Shin, Ayamine, Rando',39,344),
...
[Written by MAL Rewrite]', 'Obata, Takeshi, Hotta, Yumi',23,198),
...
[Written by MAL Rewrite]', 'Obata, Takeshi, Ohba, Tsugumi',12,108),
...
[Written by MAL Rewrite]', 'Takahashi, Rumiko',38,407),
...
[Written by MAL Rewrite]', 'Hoshino, Katsura',NULL,NULL),
...
[Written by MAL Rewrite]', 'Arakawa, Hiromu',27,116),
...
[Written by MAL Rewrite]', 'Togashi, Yoshihiro',NULL,NULL),
...
[Written by MAL Rewrite]', 'CLAMP',18,158);




INSERT INTO projet.avis (id_manga, id_utilisateur, texte, note) VALUES 
(1, 1, 'Amazing manga!', 5),
(2, 2, 'Quite interesting!', 4),
(3, 1, 'Not my type.', 2);
